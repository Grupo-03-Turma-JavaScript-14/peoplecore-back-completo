...
export class FuncaoController {
  ...
  async findByNome(
    ...
    return this.funcaoService.findByNome(nome, categoriaId ? parseInt(categoriaId) : undefined);
  }
  ...
  @Put(':id')
  @Roles(Role.ADMIN)
  async update(@Param('id', ParseIntPipe) id: number, @Body() dto: UpdateFuncaoDto) {
